...
```
    ...
    With the added linear regression model, it is possible to see that republican voters tend to be less likely of approving of a president from the other party, suggesting that they may be more politically polarized than democrat voters. It is important to note, however, that voters from both parties were much more likely to approve of a president from the other party in the past than they are now. There is a spike of approval by republican voters from 1993 to 2000, reaching levels only consistently seen in the 1960s. There is also a large drop in approval around 2005.
